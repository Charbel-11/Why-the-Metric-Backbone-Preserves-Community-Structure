import EffectiveResistanceSampling.EffRApprox as er
import EffectiveResistanceSampling.Spielman_Sparse as spl
import EffectiveResistanceSampling.RanGraphGen as rg
import EffectiveResistanceSampling.FastSims as fs
import numpy as np
...
class Network:
    def __init__(self, E_list, weights, *args):
        if len(args) != 0:
            for arg in args:
                if arg.size() > 10000:
                    A = nx.adjacency_matrix(arg, weight='proximity')
